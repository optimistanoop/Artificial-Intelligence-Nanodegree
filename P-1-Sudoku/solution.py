...
def get_naked_twins(values):
    ...
    # store and return all naked_twins
    twins = []
    for box in values:
        if len(values[box]) == 2:
...
def eliminate_naked_twins(twins, values):
...
def naked_twins(values):
    ...
    # Find all instances of naked twins
    twins = get_naked_twins(values)
    # Eliminate the naked twins as possibilities for their peers
    return eliminate_naked_twins(twins, values) 
...
def reduce_puzzle(values):
    ...
    while not stalled:
        ...
        # apply eliminate strategy to reduce puzzle
        values = eliminate(values)
        # apply only_choice strategy to reduce puzzle
...
def solve(grid):
    ...
    Args:
        ...
        Example 1:'9.1....8.8.5.7..4.2.4....6...7......5..............83.3..6......9................'
        Example 2: '2.............62....1....7...6..8...3...9...7...6..4...4....8....52.............3'
    Returns:
