...
def custom_score(game, player):
    ...
    float
        ...
        Opponent's move subtracted from own (players) move
    """
...
def custom_score_2(game, player):
    ...
    h_sq = (own_location[0] + opp_location[0]) ** 2 + (own_location[1] + opp_location[1]) ** 2
    h = math.sqrt(h_sq)
    # Distance between player and opponent.
    return float(h)
...
def custom_score_3(game, player):
    ...
    float
        ...
        Addition of blank move and moves available of a player.
    """
    if game.is_loser(player):
        return float("-inf")
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        # https://github.com/aimacode/aima-pseudocode/blob/master/md/Minimax-Decision.md
        # Refrence - classroom minimax quiz
        for move in moves:
    ...
    def min_value(self, game, depth):
        ...
        # https://github.com/aimacode/aima-pseudocode/blob/master/md/Minimax-Decision.md
        # Refrence - classroom min_value implimentation
    ...
    def max_value(self, game, depth):
        ...
        best_score = float("-inf")
        # https://github.com/aimacode/aima-pseudocode/blob/master/md/Minimax-Decision.md
        # Refrence - classroom max_value implimentation
        for move in legal_moves:
